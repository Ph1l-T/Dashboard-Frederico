...
const CLIENT_CONFIG = {
  ...
  environments: {
    ambiente1: {
      ...
      quickActions: [],
      lights: [
        { id: "9", name: "Spots Hall Entrada" },
        { id: "11", name: "Spots Móvel Parede" },
        {
          id: "45",
          name: "Spots Móvel Fachada",
          type: "dimmer",
          defaultLevel: 80,
        },
        {
          id: "46",
          name: "Spots Centrais Fachada",
          type: "dimmer",
          defaultLevel: 80,
        },
        { id: "14", name: "Spots Pilar" },
        { id: "15", name: "Spots Centrais" },
        { id: "16", name: "Spots Jantar" },
        { id: "12", name: "Spots Focais Jantar" },
      ],
      curtains: [],
      airConditioner: {
        brand: "lg",
        zones: [
          { deviceId: "91", name: "AC: I" },
          { deviceId: "90", name: "AC: II" },
          { deviceId: "95", name: "AC: III" },
        ],
    ...
    ambiente2: {
      ...
      lights: [
        ...
        {
          id: "43",
          name: "Spots Móvel Piscina",
          type: "dimmer",
          defaultLevel: 80,
        },
        {
          id: "44",
          name: "Spots Centrais Piscina",
          type: "dimmer",
          defaultLevel: 80,
        },
        { id: "14", name: "Spots Pilar" },
        { id: "15", name: "Spots Centrais" },
        { id: "21", name: "Spots Balcão" },
        { id: "12", name: "Spots Focais Balcão" },
      ],
      curtains: [],
      airConditioner: {
        brand: "lg",
        zones: [
          { deviceId: "93", name: "AC: I" },
          { deviceId: "92", name: "AC: II" },
          { deviceId: "94", name: "AC: III" },
        ],
        temperature: { min: 18, max: 25, default: 22 },
        controls: { aletas: true, windfree: false, zoneSelector: true },
      },
