  ...
  environments: {
    ...
    ambiente2: {
      ...
      airConditioner: {
        brand: "lg",
        zones: [
          { deviceId: "90", name: "AC: Hall" },
          { deviceId: "91", name: "AC: TV" },
        ],
        temperature: { min: 18, max: 25, default: 22 },
    ...
    ambiente10: {
      ...
      airConditioner: {
        brand: "lg",
        zones: [
          { deviceId: "95", name: "AC: Hall" },
          { deviceId: "94", name: "AC: Churrasqueira" },
        ],
        temperature: { min: 18, max: 25, default: 22 },
        controls: { aletas: true, windfree: false, zoneSelector: true },
      },
    ...
    ambiente3: {
      ...
      airConditioner: {
        brand: "lg",
        zones: [
          { deviceId: "93", name: "AC: Brinquedoteca" },
          { deviceId: "92", name: "AC: Churrasqueira" },
        ],
        temperature: { min: 18, max: 25, default: 22 },
        controls: { aletas: true, windfree: false, zoneSelector: true },
      },
